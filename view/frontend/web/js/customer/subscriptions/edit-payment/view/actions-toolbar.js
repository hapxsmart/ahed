define(
    ...
    function (_, Component, layout, utils, quote) {
        ...
        var defaultRendererComponent = 'Aheadworks_Sarp2/js/customer/subscriptions/edit-payment/view/actions-toolbar/renderer/default';

        return Component.extend({
            defaults: {
                template: 'Aheadworks_Sarp2/customer/subscriptions/edit-payment/actions-toolbar',
                methodCode: null,
                rendererList: {},
