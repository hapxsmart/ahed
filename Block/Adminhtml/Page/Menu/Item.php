<?php
namespace Aheadworks\Sarp2\Block\Adminhtml\Page\Menu;

use Aheadworks\Sarp2\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Sarp2\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @inheritdoc
     */
    protected $_template = 'Aheadworks_Sarp2::page/menu/item.phtml';
