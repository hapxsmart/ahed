...
/**
 * Class ResetTemporaryProfileItems
 *
 * @package Aheadworks\Sarp2\Engine\Payment\Processor\Handler\AfterPlaceOrder
 */
class ResetTemporaryProfileItems implements HandlerInterface
{
    /**
     * @var ItemManagement
     */
    ...
    public function handle(PaymentInterface $payment)
    {
        try {
            ...
            $wasReset = $this->itemManagement->resetAllReplacementItems($profile);
            if ($wasReset) {
